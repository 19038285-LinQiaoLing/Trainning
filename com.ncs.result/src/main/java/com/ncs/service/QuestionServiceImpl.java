...
public class QuestionServiceImpl implements QuestionService {
	...
	public void editQuestion(Question q) {
		int id = q.getQuestionNumber();

		Question editedQuestion = questionRepository.findById(id)
				.orElseThrow(() -> new ResourceNotFoundException("Question with ID: " + id + " not found", "Id", id));
